...
import com.eomcs.oop.ex02.domain.Score5;
...
public class ExamTest {
  ...
  public static void main (String[] args) {
    ...
    Score5 s1= new Score5("홍길동",100, 90, 80);

    printScore(s1);


    Score5 s2= new Score5("임꺽정", 95 , 85, 75 );

    printScore(s2);

    Score5 s3= new Score5("유관순", 80, 60, 50);
  ...
  static void printScore(Score5 s) {
